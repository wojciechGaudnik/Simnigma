...
def test_3r_2b (show_all=False, show_first=False, show_short=False, show_calc=False, show_uni=False):
    try:
    ...
    # text_before = convert_str_to_list("jas i dupa malgosia ")
    # print(text_before)
    # rotors = load_rotors("rotors/for_file", 6)
    ...
    # key_dec = "17as"
    # text_before = []
    # text_before = convert_str_to_list("aaaaaaaaaaaaaaaaaaaaa")#jas i dupa malgosia ")
    # text_encrypt = []
    # text_encrypt = encrypt(rotors, key_enc, text_before)
    # text_before = []
    # key_enc = []
    # # text_encrypt = [1, 2, 3, 4, 2, 3, 4, 2, 4, 3]
    # text_decrypt = []
    # text_decrypt = decrypt(rotors, key_dec, text_encrypt)
    test_print(rotors, key_enc, key_dec, text_before, text_encrypt, text_decrypt, show_all,  show_first, show_short, show_calc, show_uni)
